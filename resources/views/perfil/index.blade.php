        ...
        <div class="md:w-1/2 bg-white shadow p-6">
            <form method="POST" action="{{ route('perfil.store') }}" enctype="multipart/form-data" class="mt-10 md:mt-0">
                ...
                <div class="mb-5">
                    ...
                    <input id="username" name="username" type="text" placeher="Tu Nombre de usuario"
                ...
                <div class="mb-5">
                    ...
                    <input id="email" name="email" type="email" placeher="Tu Email de registro"
                ...
                <div class="mb-5">
                    ...
                    <input id="oldpassword" name="oldpassword" type="password" placeholder="Password actual"
                ...
                <div class="mb-5">
                    <label for="password_confirmation" class="mb-2 block uppercase text-gray-500 font-bold">Repetir Nueva
                        Password</label>
                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Confirmar Password"
